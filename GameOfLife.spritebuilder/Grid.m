...
//        for (int x = (i-1); x <= (i+1); x++)
//        {
//            // go through the column to the left of the current cell, the column the cell is in, and the
...
//            
       ...
       if (currentCreature.livingNeighbors==3) { currentCreature.isAlive= TRUE; }
